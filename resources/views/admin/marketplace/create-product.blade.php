...
<div class="create-product">
    ...
    <div class="page-header">
        <div class="header-content">
            <div class="header-left">
                ...
                <p class="page-subtitle">Tambahkan produk baru dari UMKM ke marketplace</p>
            </div>
    ...
    <!-- Form -->
    <form method="POST" action="{{ route('admin.marketplace.products.store') }}" enctype="multipart/form-data" class="product-form">
        @csrf
        ...
        <div class="form-sections">
            ...
            <div class="form-section">
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="price" name="price" value="{{ old('price') }}" required min="0" class="form-input">
                        @error('price')
                            <span class="error-message">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="stock" name="stock" value="{{ old('stock') }}" required min="0" class="form-input">
                        @error('stock')
                            <span class="error-message">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="weight" name="weight" value="{{ old('weight') }}" required min="0" step="0.01" class="form-input">
                        @error('weight')
                            <span class="error-message">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group span-2">
                        ...
                        <textarea id="description" name="description" required rows="4" class="form-textarea">{{ old('description') }}</textarea>
                        @error('description')
                            <span class="error-message">{{ $message }}</span>
                        @enderror
                    </div>
            ...
            <div class="form-section">
                <div class="section-header">
                    ...
                    <p class="section-subtitle">Upload gambar produk (maksimal 5 gambar)</p>
                </div>
            ...
            <div class="form-section">
                <div class="section-header">
                    ...
                    <p class="section-subtitle">Tambahkan spesifikasi detail produk</p>
                </div>
            ...
            <div class="form-section">
                ...
                <div class="form-grid">
                    <div class="form-group">
                        ...
                        <input type="number" id="discount_percentage" name="discount_percentage" value="{{ old('discount_percentage') }}" min="0" max="100" step="0.01" class="form-input">
                    ...
                    <div class="form-group">
                        ...
                        <input type="datetime-local" id="discount_starts_at" name="discount_starts_at" value="{{ old('discount_starts_at') }}" class="form-input">
                    ...
                    <div class="form-group">
                        ...
                        <input type="datetime-local" id="discount_ends_at" name="discount_ends_at" value="{{ old('discount_ends_at') }}" class="form-input">
